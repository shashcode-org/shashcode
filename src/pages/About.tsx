...
const About = () => {
  ...
  const certifications = [
    "Software Complexity Professional",
    "Software Complexity Advanced"
  ];
  ...
  const programmingLanguages = [
    "GoLang", "Java", "Python", "JavaScript", "React", "Node", "Android"
  ];

  const backendDevelopment = [
    "Microservices", "REST APIs", "AWS", "Web Socket", "Database Management", "Performance Optimization"
  ];

  const performanceTesting = [
    "Load testing", "stress testing, system benchmarks"
  ];

  const dataAnalytics = [
    "Python, Pandas, SciKit-Learn, Tableau, Descriptive Analytics"
  ];
    ...
    <div className="min-h-screen flex flex-col bg-background">
            ...
            <CardContent>
              <div className="flex flex-col md:flex-row items-start gap-8">
                ...
                <div className="w-full md:w-2/3 space-y-4">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    ShashCode is a platform dedicated to making coding and technology education accessible to everyone. It helps students and professionals master <strong>Coding & Data Structures and Algorithms (DSA) in Java</strong> for placements.
                  </p>
                  <p className="text-gray-600 leading-relaxed">
                    Founded by <strong className="text-primary">Shashwat Tiwari</strong>, a software engineer and content creator, ShashCode simplifies complex topics through structured learning paths, coding sheets, and video tutorials.
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="p-8 bg-primary/5">
            <CardContent className="text-center space-y-6">
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                At ShashCode, we believe in <strong>learning by doing</strong>. Our goal is to provide <strong>free, high-quality coding resources</strong> to help aspiring developers crack top tech company interviews and build strong problem-solving skills.
              </p>
              <p className="text-gray-600 leading-relaxed">
            ...
            <CardContent>
              <div className="flex flex-col md:flex-row items-start gap-8">
                ...
                <div className="w-full md:w-1/3 flex flex-col items-center">
                  ...
                  <p className="text-gray-600 font-semibold text-center">Senior Engineer | Educator |</p>
                ...
                <div className="w-full md:w-2/3 space-y-4">
                  <p className="text-gray-600 leading-relaxed">
                    <strong>Shashwat Tiwari</strong> is a <strong>Senior Engineer at Samsung Research</strong>, where he specializes in backend systems, microservices, and performance optimization. He is also a passionate educator with a rapidly growing tech channel, <strong>ShashCode</strong>, where he simplifies <strong>Data Structures & Algorithms (DSA)</strong>, coding interviews, and software engineering placements.
                  </p>
                  <p className="text-gray-600 leading-relaxed">
                    He brings thought-provoking <strong>YouTube channel, ShashCode</strong>, where he amplifies learning for thousands through structured <strong>Java + DSA sheets</strong>, coding interviews, and career guidance. His approach emphasizes clarity and real-world application, helping learners build industry-relevant skills.
                  </p>
                  <p className="text-gray-600 leading-relaxed">
                    Shashwat's blend of industry experience and teaching expertise make him a valuable mentor for aspiring engineers, data analysts, and software developers. His commitment to empowering others through clear, step-by-step technical content and strong knowledge has helped thousands tackle complex concepts and advance in their coding journey.
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold">National Payments Corporation of India (NPCI) – Engineer</h3>
                  </div>
                </div>

                <div className="flex items-start gap-4">
                  <img src={cognizantLogo} alt="Cognizant" className="h-10 object-contain flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold">Cognizant Technology Solutions – Programmer Analyst</h3>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold">Hindustan Petroleum Corporation Limited (HPCL) – Data Analyst Intern</h3>
                  </div>
                </div>
      ...
      <Section gradient contentClassName="max-w-4xl mx-auto">
        <AnimatedElement animation="fadeIn">
          <Card className="p-8">
            <CardContent>
              <h2 className="text-2xl font-bold text-primary mb-6 text-center">Mentorship & Teaching</h2>
              <ul className="space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="md:col-span-2">
                  ...
                  <p className="text-gray-600 mt-2">
                    Shashwat's blend of industry experience and teaching expertise makes him a valuable mentor for aspiring engineers, data analysts, and software developers. His commitment to empowering others through clear, structured learning material, tech insights, and strong knowledge has helped thousands in their careers and shared knowledge has helped thousands tackle complex DSA concepts and placements, and advance in their coding journey.
                  </p>
                </div>
              </div>
            </CardContent>
