  ...
  return (
    <div className="mt-10">
      ...
      <section className="bg-gray-900 py-16 px-6">
        <h2 className="text-2xl sm:text-3xl font-bold text-center text-signature_yellow mb-10">Meet the Instructor</h2>
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row-reverse items-center gap-10">
          ...
          <div className="flex flex-col items-center w-full sm:w-[30%]">
            <img
              src={instructorImg}
              alt="Instructor"
              className="rounded-full w-[50%] sm:w-full h-full object-scale-down shadow-xl aspect-square" // Increased size
            />
          ...
          {/* Left Side - Bio */}
          <div className="text-gray-300 text-sm sm:text-[16px] leading-relaxed space-y-5 sm:w-[70%] text-center md:text-left">
            <p>
            ...
            {/* Logos */}
            <div className='mt-4'>
              {/* No need of : here, Professional Experience: */}
              <h4 className="text-lg font-semibold text-signature_yellow">Professional Experience</h4>
              <div className="flex gap-6 flex-wrap items-center mt-0">
