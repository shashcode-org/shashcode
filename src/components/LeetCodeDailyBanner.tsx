    ...
    <div className="px-4 sm:px-6 lg:px-8 -mt-4 mb-4 sm:mb-8">
      ...
      >
        <button
          ...
          className="absolute top-4 right-4 sm:top-5 sm:right-5 z-10 text-xs text-muted-foreground hover:text-foreground transition"
          aria-label="Dismiss challenge banner"
        >
          Dismiss
        </button>

        <div className="p-6 sm:p-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 pr-16 sm:pr-20">
          <div className="flex-1 min-w-0">
            <span className="text-xs font-semibold tracking-wide text-primary uppercase">
              Live now · 100-Day Challenge
            </span>
            <h3 className="mt-2 text-xl sm:text-2xl font-semibold text-foreground leading-tight font-heading">
