    ...
    return (
        ...
        >
            <div
                ...
                className="w-full max-w-2xl max-h-[calc(100vh-2rem)] md:max-h-[90vh] min-h-0 rounded-3xl bg-card border border-border shadow-2xl flex flex-col overflow-hidden"
