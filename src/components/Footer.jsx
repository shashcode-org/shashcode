    ...
    <footer className="bg-black text-white py-8 mt-16">
      <div className="w-[90%] md:w-3/4 mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex gap-6 text-gray-300 text-sm">
          {/* <a href="/about" className="hover:text-signature_yellow">About</a> */}
          <a href="/dsa" className="hover:text-signature_yellow">Java DSA Sheet</a>
          {/* <a href="/contact" className="hover:text-signature_yellow">Contact</a> */}
        </div>
      </div>

      {/* Contact & Social Links */}
      <div className="w-[90%] md:w-3/4 mx-auto mt-8 text-sm text-center text-gray-300 space-y-2">
        <p>Email: <a href="mailto:collaboratewithshashwat@gmail.com" className="hover:text-signature_yellow">collaboratewithshashwat@gmail.com</a></p>
      ...
      <div className="text-center text-gray-500 text-xs mt-6">
        ...
        <div className="mt-2">
          <a href="/terms" className="hover:text-signature_yellow mx-2">Terms & Conditions</a>|
          <a href="/privacy" className="hover:text-signature_yellow mx-2">Privacy Policy</a>
        </div>
      </div>
    </footer>
  );
